...
class TabLink {
  constructor(element) {
    ...
    this.itemElement = document.querySelector(`.itemElement[data-tab='${this.data}']`);
...
links = document.querySelectorAll(".tabs-link").forEach( tabs-link => {
  return new TabLink(tabs-link);
});